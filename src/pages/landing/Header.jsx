    ...
    <header className='bg-red-50 bg-opacity-30 flex flex-col items-center px-5 md:h-screen'>
      ...
      <div className='flex flex-col items-center text-center md:w-4/6'>
        ...
        <div className='flex flex-col gap-5 mt-[92px] mb-12 md:gap-10 md:mb-0 md:flex-row'>
          <Link to="/zuriclone/training" className="btn bg-red-500 hover:bg-white text-white hover:text-red-500 border border-red-500">I'm new to the Industry</Link>
          <Link to="/zuriclone/talent" className="btn bg-white hover:bg-red-500 text-red-500 border hover:text-white border-red-500">I need industry experience</Link>
        </div>
      </div>
    </header>
  )
